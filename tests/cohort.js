 ...
 * @param {IsInitialContent} [opts.isInitialContent] forwarded to the sync plugin (custom initial-state check)
...
export const createPMView = (ytype, renderer = null, opts = {}) => {
  ...
  if (opts.isInitialContent) pluginOpts.isInitialContent = opts.isInitialContent
